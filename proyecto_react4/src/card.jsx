...
export default function Card() {
  ...
  return (
    ...
    >
      ...
      <img src="https://i.pravatar.cc/150?img=3"alt="Perfil"className="rounded-full w-32 mx-auto"/>
      ...
      <button
        onClick={toggleDarkMode}className={`mt-6 px-4 py-2 rounded block mx-auto ${
